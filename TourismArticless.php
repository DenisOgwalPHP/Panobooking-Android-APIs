...
$realacc=test_input($_GET["realacc"]);
  //creating a query
  //error_log($realacc);
 $stmt =$link->prepare("SELECT IDs,ArticleTitle,PostedBy,PostedAt,ArticleThumbNail,Attachment,Details FROM tourismarticles where IDs='".$realacc."' order by IDs ASC");
 //executing the query 
 $stmt->execute();
